        ...
        <div class="container dashboard__container">
            <aside>
                <ul>
                    ...
                    <li><a href="../controller/controller-manageCategories.php" class="active"><i class="uil uil-list-ul"></i>
                        <h5>Manage Category</h5>
                    </a></li>
                    <li><a href="../views/add-user.php"><i class="uil uil-user-plus"></i>
                        <h5>Add User</h5>
                    </a></li>
                    <li><a href="../controller/controller-manageUser.php"><i class="uil uil-users-alt"></i>
                        <h5>Manage User</h5>
                    </a></li>
                </ul>
            </aside>
